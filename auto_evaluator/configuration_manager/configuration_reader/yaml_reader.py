import yaml
from auto_evaluator.configuration_manager.configuration_reader.configuration_reader_interface import ConfigurationReader
from auto_evaluator.configuration_manager.readers_serializers.yaml_serializer import YamlSerializer
